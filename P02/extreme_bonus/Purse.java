//Kaitlynn Hernandez CSE1325 P02 Extreme Bonus
public class Purse {
	public static void main (String[] args){
		...
		//print total
		System.out.printf("You have $ %.2f in coins between %d and %d weighing %.3f grams%n", total, earliestCoin, latestCoin, totalWeight);
	}
}